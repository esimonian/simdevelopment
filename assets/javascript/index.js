    ...
    if (void 0 !== a && 0 <= a.innerHTML.indexOf("data-srcset")) return a = a.innerHTML.match(/data-srcset="([A-z0-9%_\.-]+)/i)[0], decodeURIComponent(a).split('"')[1];
      ...
      function m(a) {
        ...
        0 < l(c[e], "timeline-Tweet-retweetCredit").length ? b.push(!0) : b.push(!1);if (!b[e] || b[e] && B) a.push(l(c[e], "timeline-Tweet-text")[0]), q.push(c[e].getAttribute("data-tweet-id")), k.push(m(l(c[e], "timeline-Tweet-author")[0])), f.push(l(c[e], "dt-updated")[0]), n.push(l(c[e], "timeline-Tweet-timestamp")[0]), void 0 !== l(c[e], "timeline-Tweet-media")[0] ? h.push(l(c[e], "timeline-Tweet-media")[0]) : h.push(void 0);e++;
          ...
          e = a.length,
          d = 0;if (K) for (; d < e;) {
        c.push({ tweet: a[d].innerHTML, author: k[d].innerHTML, time: f[d].textContent, image: F(h[d]), rt: b[d], tid: q[d], permalinkURL: void 0 === n[d] ? "" : n[d].href }), d++;
      } else for (; d < e;) {
        if ("string" !== typeof z) {
          var b = f[d].getAttribute("datetime"),
              u = new Date(f[d].getAttribute("datetime").replace(/-/g, "/").replace("T", " ").split("+")[0]),
              b = z(u, b);f[d].setAttribute("aria-label", b);if (a[d].textContent) {
            if (A) f[d].textContent = b;else {
 ...
 */
!function (t) {
  "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? t(require("jquery")) : t(jQuery);
}(function (t) {
  function e(t) {
    ...
    var l = [],
      ...
      var e = t(this);if (this !== document && this !== window) return !document.scrollingElement || this !== document.documentElement && this !== document.body ? (e[n]() > 0 ? l.push(this) : (e[n](1), o = e[n]() > 0, o && l.push(this), e[n](0)), void 0) : (l.push(document.scrollingElement), !1);
      ...
      if (l = l || {}, "options" === l) return o ? this.each(function () {
        ...
        var o = this,
            ...
            g = e(o.hash);if (i.scrollTarget || m && p && g) {
          for (; h && f < c.length;) {
            r.is(e(c[f++])) && (h = !1);
          }for (; h && u < a.length;) {
            r.closest(a[u++]).length && (h = !1);
          }
        } else h = !1;h && (i.preventDefault && l.preventDefault(), t.extend(d, i, { scrollTarget: i.scrollTarget || g, link: o }), t.smoothScroll(d));
      }), this;
    ...
    if ("options" === e && "object" == (typeof l === "undefined" ? "undefined" : _typeof(l))) return t.extend(o, l);var n,
        ...
        u = "scrollTop",
        h = {},
        d = {};"number" == typeof e ? (n = t.extend({ link: null }, t.fn.smoothScroll.defaults, o), r = e) : (n = t.extend({ link: null }, t.fn.smoothScroll.defaults, e || {}, o), n.scrollElement && (f = "position", "static" === n.scrollElement.css("position") && n.scrollElement.css("position", "relative"))), u = "left" === n.direction ? "scrollLeft" : u, n.scrollElement ? (s = n.scrollElement, /^(?:HTML|BODY)$/.test(s[0].nodeName) || (a = s[u]())) : s = t("html, body").firstScrollable(n.direction), n.beforeScroll.call(s, n), r = "number" == typeof e ? e : l || t(n.scrollTarget)[f]() && t(n.scrollTarget)[f]()[n.direction] || 0, h[u] = r + a + n.offset, i = n.speed, "auto" === i && (c = h[u] - s.scrollTop(), 0 > c && (c *= -1), i = c / n.autoCoefficient), d = { duration: i, easing: n.easing, complete: function complete() {
...
function mr_parallax() {
  ...
  function a(a) {
    ...
    var a,
        b = 0;return j() ? (b = jQuery(".viu").find("nav:first").outerHeight(!0), a = jQuery(".viu").find("nav:first").css("position"), ("absolute" === a || "fixed" === a) && (b = 0)) : b = jQuery(document).find("nav:first").outerHeight(!0), b;
  }function c(a, b, c, d) {
    var e = a - 1;return e /= d, a /= d, e--, a--, c * (a * a * a * a * a + 1) + b - (c * (e * e * e * e * e + 1) + b);
  }function d() {
    if (F) {
    ...
    var e = j();e ? b + q - r > a.elemTop && b - r < a.elemBottom && (a.isFirstSection ? a.imageHolder.style[n] = c + b / 2 + d : a.imageHolder.style[n] = c + (b - a.elemTop - r) / 2 + d) : b + q > a.elemTop && b < a.elemBottom && (a.isFirstSection ? a.imageHolder.style[n] = c + b / 2 + d : a.imageHolder.style[n] = c + (b + q - a.elemTop) / 2 + d);
  }function f() {
    ...
    return "undefined" == typeof window.mr_variant ? !1 : !0;
      ...
      E = window,
      F = (j(), !1),
      G = this;this.mr_scrollAssist = $("body").hasClass("scroll-assist") ? !0 : !1, jQuery(document).ready(function () {
    G.documentReady();
    ...
    k = [], r = b();var a = j(),
        c = ".parallax > .background-image-holder, .parallax ul.slides > li > .background-image-holder, .parallax ul.slides .owl-item > li > .background-image-holder";a && (c = ".viu .parallax > .background-image-holder, .viu .parallax ul.slides > li > .background-image-holder, .parallax ul.slides .owl-item > li > .background-image-holder"), jQuery(c).each(function (b) {
      var c = jQuery(this).closest(".parallax"),
          d = a ? c.position().top : c.offset().top;k.push({ section: c.get(0), outerHeight: c.outerHeight(), elemTop: d, elemBottom: d + c.outerHeight(), isFirstSection: c.is(":nth-of-type(1)") ? !0 : !1, imageHolder: jQuery(this).get(0) }), a ? a && (c.is(":nth-of-type(1)") ? G.mr_setTranslate3DTransform(jQuery(this).get(0), 0 === f() ? 0 : f() / 2) : G.mr_setTranslate3DTransform(jQuery(this).get(0), (f() - d - r) / 2)) : c.is(":nth-of-type(1)") ? G.mr_setTranslate3DTransform(jQuery(this).get(0), 0 === f() ? 0 : f() / 2) : G.mr_setTranslate3DTransform(jQuery(this).get(0), (f() + q - d) / 2);
    });
  ...
  function c(b, c, g, h) {
    b[d](f + c, "wheel" == e ? g : function (b) {
      !b && (b = a.event);var c = { originalEvent: b, target: b.target || b.srcElement, type: "wheel", deltaMode: "MozMousePixelScroll" == b.type ? 0 : 1, deltaX: 0, deltaZ: 0, notRealWheel: 1, preventDefault: function preventDefault() {
      ...
      e,
      f = "";a.addEventListener ? d = "addEventListener" : (d = "attachEvent", f = "on"), e = "onwheel" in b.createElement("div") ? "wheel" : "undefined" != typeof b.onmousewheel ? "mousewheel" : "DOMMouseScroll", a.addWheelListener = function (a, b, d) {
...
var mr = function ($, window, document) {
    ...
    function windowLoad(context) {
        ...
        context = (typeof context === "undefined" ? "undefined" : _typeof(context)) == "object" ? $ : context;
...
mr = function (mr, $, window, document) {
    ...
    mr.util.slugify = function (text, spacesOnly) {
        if ((typeof spacesOnly === "undefined" ? "undefined" : _typeof(spacesOnly)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined))) {
    ...
    mr.util.sortChildrenByText = function (parentElement, reverse) {
        ...
        var order = -1;
        var order2 = 1;
        if ((typeof reverse === "undefined" ? "undefined" : _typeof(reverse)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined))) {
            order = 1;order2 = -1;
        }
    ...
    mr.util.idleSrc = function (context, selector) {
        ...
        selector = (typeof selector === "undefined" ? "undefined" : _typeof(selector)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? selector : '';
        ...
        elems.each(function (index, elem) {
            ...
            if ((typeof dataSrc === "undefined" ? "undefined" : _typeof(dataSrc)) === (typeof undefined === "undefined" ? "undefined" : _typeof(undefined))) {
...
mr = function (mr, $, window, document) {
    ...
    mr.forms.submit = function (e) {
        ...
        if (formAction.indexOf('createsend.com') !== -1 || formAction.indexOf('list-manage.com') !== -1) {
            ...
            if ((typeof originalError === "undefined" ? "undefined" : _typeof(originalError)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) && originalError !== false) {
                    ...
                    $.ajax({
                        ...
                        success: function success(data) {
                            ...
                            if (data.result !== "success" && data.Status !== 200) {
                                ...
                                if ((typeof successRedirect === "undefined" ? "undefined" : _typeof(successRedirect)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) && successRedirect !== false && successRedirect !== "") {
    ...
    mr.maps.initAPI = function () {
        ...
        if (document.querySelector('[data-maps-api-key]') && !document.querySelector('.gMapsAPI')) {
            if ($('[data-maps-api-key]').length) {
                ...
                apiKey = (typeof apiKey === "undefined" ? "undefined" : _typeof(apiKey)) != (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? apiKey : '';
                if (apiKey !== '') {
        ...
        if (typeof window.google !== "undefined") {
            if (typeof window.google.maps !== "undefined") {
                $('.map-container[data-maps-api-key]').each(function () {
                    var mapElement = this,
                        mapInstance = $(this),
                        mapJSON = _typeof(mapInstance.attr('data-map-style')) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? mapInstance.attr('data-map-style') : false,
                        ...
                        zoomLevel = _typeof(mapInstance.attr('data-map-zoom')) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) && mapInstance.attr('data-map-zoom') !== "" ? mapInstance.attr('data-map-zoom') * 1 : 17,
                        ...
                        markerImage = _typeof(mapInstance.attr('data-marker-image')) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? mapInstance.attr('data-marker-image') : 'img/mapmarker.png',
                    ...
                    if (_typeof(mapInstance.attr('data-marker-title')) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) && mapInstance.attr('data-marker-title') !== "") {
                        ...
                        geocoder.geocode({ 'address': address[0].replace('[nomarker]', '') }, function (results, status) {
                            if (status == google.maps.GeocoderStatus.OK) {
                                ...
                                address.forEach(function (address) {
                                    ...
                                    markerImage = { url: _typeof(window.mr_variant) === (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? markerImage : '../img/mapmarker.png', scaledSize: new google.maps.Size(50, 50) };
                    ...
                    } else if ((typeof latitude === "undefined" ? "undefined" : _typeof(latitude)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) && latitude !== "" && latitude !== false && (typeof longitude === "undefined" ? "undefined" : _typeof(longitude)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) && longitude !== "" && longitude !== false) {
...
mr = function (mr, $, window, document) {
    ...
    var documentReady = function documentReady($) {
        ...
        if ((typeof mr_variant === "undefined" ? "undefined" : _typeof(mr_variant)) == (typeof undefined === "undefined" ? "undefined" : _typeof(undefined))) {
    ...
    mr.modals.showModal = function (modal, millisecondsDelay) {
        ...
        var delay = (typeof millisecondsDelay === "undefined" ? "undefined" : _typeof(millisecondsDelay)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? 1 * millisecondsDelay : 0;
...
mr = function (mr, $, window, document) {
    ...
    mr.navigation.bar.init = function () {
        ...
        mr.navigation.bar.fixedAt = (typeof fixedAt === "undefined" ? "undefined" : _typeof(fixedAt)) !== (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? parseInt(fixedAt.replace('px', ''), 10) : false;
...
mr = function (mr, $, window, document) {
    ...
    mr.notifications.closeNotification = function (notification) {
        ...
        notification = $notification.is('.notification-close') ? $notification.closest('.notification') : $('body').find('.notification[data-notification-link="' + notification + '"]');
